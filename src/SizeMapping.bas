...
''''''' =====================================================================
'''''''
''''''' WHY THIS WORKS WITHOUT PARSING BRACKET POSITION:
'''''''
'''''''   - Variety is read directly from Cells(vals, 4).
'''''''   - The actual carton pack for this line is read directly from
'''''''     Cells(vals, 8).
'''''''   - Because both are known, we don't need to guess which bracket
'''''''     position belongs to which carton. We just look up, from the
'''''''     reference table, every COUNT value that variety+pack could ever
'''''''     have, and check which of those values literally appear anywhere
'''''''     in the header cell text (order doesn't matter, number of values
'''''''     doesn't matter, spacing doesn't matter).
'''''''
'''''''   - If exactly one of that pack's known counts appears in the header
'''''''     -> use it directly.
'''''''   - If more than one appears (e.g. the old "20,22" case, now
'''''''     generalized to any number of matches) -> sum them via chained
'''''''     COUNTIFS blocks, same pattern as the original special case.
...
''''''' to change - no new Case blocks, no new permutations.
''''''' =====================================================================
...
Private Const SIZE_DATA As String = _
    ...
    "EUR|0|A15C|56" & vbCrLf & "EUR|1|A15C|64" & vbCrLf & "EUR|2|A15C|75" & vbCrLf & "EUR|3|A15C|88" & vbCrLf & "EUR|3|A15C|100" & vbCrLf & "EUR|4|A15C|113" & vbCrLf & "EUR|5|A15C|138" & vbCrLf & "EUR|6|A15C|162" & vbCrLf & "EUR|6|A15C|189" & vbCrLf & "EUR|7|A15C|216" & vbCrLf & "EUR|1|E15D|70" & vbCrLf & "EUR|2|E15D|80" & vbCrLf & "EUR|3|E15D|90" & vbCrLf & "EUR|3|E15D|96" & vbCrLf & "EUR|1|E15C|70" & vbCrLf & "EUR|2|E15C|80" & vbCrLf & "EUR|3|E15C|90" & vbCrLf & "EUR|3|E15C|96" & vbCrLf & "EUR|1|D15D|70" & vbCrLf & "EUR|2|D15D|80" & vbCrLf & "EUR|3|D15D|90" & vbCrLf & "EUR|3|D15D|96" & vbCrLf & "EUR|1|C15D|70" & vbCrLf & "EUR|2|C15D|80" & vbCrLf & "EUR|3|C15D|90" & vbCrLf & "EUR|3|C15D|96" & vbCrLf & _
    ...
    "SHD|2|A15C|6" & vbCrLf & "SHD|3|A15C|8" & vbCrLf & "SHD|3|A15C|10" & vbCrLf & "SHD|4|A15C|12" & vbCrLf & "SHD|5|A15C|14" & vbCrLf & "SHD|6|A15C|18" & vbCrLf & "SHD|7|A15C|23" & vbCrLf & "SHD|3|C15D|9" & vbCrLf & "SHD|3|C15D|10" & vbCrLf & "SHD|4|C15D|12" & vbCrLf & "SHD|5|C15D|13" & vbCrLf & "SHD|5|C15D|14" & vbCrLf & "SHD|3|D15D|9" & vbCrLf & "SHD|3|D15D|10" & vbCrLf & "SHD|4|D15D|12" & vbCrLf & "SHD|5|D15D|13" & vbCrLf & "SHD|5|D15D|14" & vbCrLf & "SHD|6|G15C|24" & vbCrLf & "SHD|7|G15C|28" & vbCrLf & "SHD|6|G15D|24" & vbCrLf & "SHD|7|G15D|28" & vbCrLf & "SHD|6|H15C|24" & vbCrLf & "SHD|7|H15C|28" & vbCrLf & "SHD|6|H15D|24" & vbCrLf & "SHD|7|H15D|28" & vbCrLf & _
    ...
    "DEL|0|A15C|32" & vbCrLf & "DEL|1|A15C|36" & vbCrLf & "DEL|2|A15C|40" & vbCrLf & "DEL|3|A15C|48" & vbCrLf & "DEL|4|A15C|56" & vbCrLf & "DEL|5|A15C|64" & vbCrLf & "DEL|6|A15C|72" & vbCrLf & "DEL|7|A15C|88" & vbCrLf & "DEL|8|A15C|105" & vbCrLf & "DEL|9|A15C|125" & vbCrLf & "DEL|0|E15D|40" & vbCrLf & "DEL|1|E15D|45" & vbCrLf & "DEL|2|E15D|50" & vbCrLf & "DEL|3|E15D|55" & vbCrLf & "DEL|4|E15D|60" & vbCrLf & "DEL|5|E15D|65" & vbCrLf & "DEL|6|E15D|72" & vbCrLf & "DEL|7|E15D|90" & vbCrLf & "DEL|8|E15D|96" & vbCrLf & "DEL|0|E15C|40" & vbCrLf & "DEL|1|E15C|45" & vbCrLf & "DEL|2|E15C|50" & vbCrLf & "DEL|3|E15C|55" & vbCrLf & _
    "DEL|4|E15C|60" & vbCrLf & "DEL|5|E15C|65" & vbCrLf & "DEL|6|E15C|72" & vbCrLf & "DEL|7|E15C|90" & vbCrLf & "DEL|8|E15C|96" & vbCrLf & "DEL|0|D15D|40" & vbCrLf & "DEL|1|D15D|45" & vbCrLf & "DEL|2|D15D|50" & vbCrLf & "DEL|3|D15D|55" & vbCrLf & "DEL|4|D15D|60" & vbCrLf & "DEL|5|D15D|65" & vbCrLf & "DEL|6|D15D|72" & vbCrLf & "DEL|7|D15D|90" & vbCrLf & "DEL|8|D15D|96" & vbCrLf & "DEL|0|C15D|40" & vbCrLf & "DEL|1|C15D|45" & vbCrLf & "DEL|2|C15D|50" & vbCrLf & "DEL|3|C15D|55" & vbCrLf & "DEL|4|C15D|60" & vbCrLf & "DEL|5|C15D|65" & vbCrLf & "DEL|6|C15D|72" & vbCrLf & "DEL|7|C15D|90" & vbCrLf & "DEL|8|C15D|96" & vbCrLf & _
    "APV|0|A15C|32" & vbCrLf & "APV|1|A15C|36" & vbCrLf & "APV|2|A15C|40" & vbCrLf & "APV|3|A15C|48" & vbCrLf & "APV|4|A15C|56" & vbCrLf & "APV|5|A15C|64" & vbCrLf & "APV|6|A15C|72" & vbCrLf & "APV|7|A15C|88" & vbCrLf & "APV|8|A15C|105" & vbCrLf & "APV|9|A15C|125" & vbCrLf & "APV|0|E15D|40" & vbCrLf & "APV|1|E15D|45" & vbCrLf & "APV|2|E15D|50" & vbCrLf & "APV|3|E15D|55" & vbCrLf & "APV|4|E15D|60" & vbCrLf & "APV|5|E15D|65" & vbCrLf & "APV|6|E15D|72" & vbCrLf & "APV|7|E15D|90" & vbCrLf & "APV|8|E15D|96" & vbCrLf & "APV|0|E15C|40" & vbCrLf & "APV|1|E15C|45" & vbCrLf & "APV|2|E15C|50" & vbCrLf & "APV|3|E15C|55" & vbCrLf & _
    "APV|4|E15C|60" & vbCrLf & "APV|5|E15C|65" & vbCrLf & "APV|6|E15C|72" & vbCrLf & "APV|7|E15C|90" & vbCrLf & "APV|8|E15C|96" & vbCrLf & "APV|0|D15D|40" & vbCrLf & "APV|1|D15D|45" & vbCrLf & "APV|2|D15D|50" & vbCrLf & "APV|3|D15D|55" & vbCrLf & "APV|4|D15D|60" & vbCrLf & "APV|5|D15D|65" & vbCrLf & "APV|6|D15D|72" & vbCrLf & "APV|7|D15D|90" & vbCrLf & "APV|8|D15D|96" & vbCrLf & "APV|0|C15D|40" & vbCrLf & "APV|1|C15D|45" & vbCrLf & "APV|2|C15D|50" & vbCrLf & "APV|3|C15D|55" & vbCrLf & "APV|4|C15D|60" & vbCrLf & "APV|5|C15D|65" & vbCrLf & "APV|6|C15D|72" & vbCrLf & "APV|7|C15D|90" & vbCrLf & "APV|8|C15D|96" & vbCrLf & _
    "MKN|0|A15C|32" & vbCrLf & "MKN|1|A15C|36" & vbCrLf & "MKN|2|A15C|40" & vbCrLf & "MKN|3|A15C|48" & vbCrLf & "MKN|4|A15C|56" & vbCrLf & "MKN|5|A15C|64" & vbCrLf & "MKN|6|A15C|72" & vbCrLf & "MKN|7|A15C|88" & vbCrLf & "MKN|8|A15C|105" & vbCrLf & "MKN|9|A15C|125" & vbCrLf & "MKN|0|E15D|40" & vbCrLf & "MKN|1|E15D|45" & vbCrLf & "MKN|2|E15D|50" & vbCrLf & "MKN|3|E15D|55" & vbCrLf & "MKN|4|E15D|60" & vbCrLf & "MKN|5|E15D|65" & vbCrLf & "MKN|6|E15D|72" & vbCrLf & "MKN|7|E15D|90" & vbCrLf & "MKN|8|E15D|96" & vbCrLf & "MKN|0|E15C|40" & vbCrLf & "MKN|1|E15C|45" & vbCrLf & "MKN|2|E15C|50" & vbCrLf & "MKN|3|E15C|55" & vbCrLf & _
    "MKN|4|E15C|60" & vbCrLf & "MKN|5|E15C|65" & vbCrLf & "MKN|6|E15C|72" & vbCrLf & "MKN|7|E15C|90" & vbCrLf & "MKN|8|E15C|96" & vbCrLf & "MKN|0|D15D|40" & vbCrLf & "MKN|1|D15D|45" & vbCrLf & "MKN|2|D15D|50" & vbCrLf & "MKN|3|D15D|55" & vbCrLf & "MKN|4|D15D|60" & vbCrLf & "MKN|5|D15D|65" & vbCrLf & "MKN|6|D15D|72" & vbCrLf & "MKN|7|D15D|90" & vbCrLf & "MKN|8|D15D|96" & vbCrLf & "MKN|0|C15D|40" & vbCrLf & "MKN|1|C15D|45" & vbCrLf & "MKN|2|C15D|50" & vbCrLf & "MKN|3|C15D|55" & vbCrLf & "MKN|4|C15D|60" & vbCrLf & "MKN|5|C15D|65" & vbCrLf & "MKN|6|C15D|72" & vbCrLf & "MKN|7|C15D|90" & vbCrLf & "MKN|8|C15D|96" & vbCrLf & _
    "GSV|0|A15C|32" & vbCrLf & "GSV|1|A15C|36" & vbCrLf & "GSV|2|A15C|40" & vbCrLf & "GSV|3|A15C|48" & vbCrLf & "GSV|4|A15C|56" & vbCrLf & "GSV|5|A15C|64" & vbCrLf & "GSV|6|A15C|72" & vbCrLf & "GSV|7|A15C|88" & vbCrLf & "GSV|8|A15C|105" & vbCrLf & "GSV|9|A15C|125" & vbCrLf & "GSV|0|E15D|40" & vbCrLf & "GSV|1|E15D|45" & vbCrLf & "GSV|2|E15D|50" & vbCrLf & "GSV|3|E15D|55" & vbCrLf & "GSV|4|E15D|60" & vbCrLf & "GSV|5|E15D|65" & vbCrLf & "GSV|6|E15D|72" & vbCrLf & "GSV|7|E15D|90" & vbCrLf & "GSV|8|E15D|96" & vbCrLf & "GSV|0|E15C|40" & vbCrLf & "GSV|1|E15C|45" & vbCrLf & "GSV|2|E15C|50" & vbCrLf & "GSV|3|E15C|55" & vbCrLf & _
    "GSV|4|E15C|60" & vbCrLf & "GSV|5|E15C|65" & vbCrLf & "GSV|6|E15C|72" & vbCrLf & "GSV|7|E15C|90" & vbCrLf & "GSV|8|E15C|96" & vbCrLf & "GSV|0|D15D|40" & vbCrLf & "GSV|1|D15D|45" & vbCrLf & "GSV|2|D15D|50" & vbCrLf & "GSV|3|D15D|55" & vbCrLf & "GSV|4|D15D|60" & vbCrLf & "GSV|5|D15D|65" & vbCrLf & "GSV|6|D15D|72" & vbCrLf & "GSV|7|D15D|90" & vbCrLf & "GSV|8|D15D|96" & vbCrLf & "GSV|0|C15D|40" & vbCrLf & "GSV|1|C15D|45" & vbCrLf & "GSV|2|C15D|50" & vbCrLf & "GSV|3|C15D|55" & vbCrLf & "GSV|4|C15D|60" & vbCrLf & "GSV|5|C15D|65" & vbCrLf & "GSV|6|C15D|72" & vbCrLf & "GSV|7|C15D|90" & vbCrLf & "GSV|8|C15D|96" & vbCrLf & _
    "CAR|0|A15C|32" & vbCrLf & "CAR|1|A15C|36" & vbCrLf & "CAR|2|A15C|40" & vbCrLf & "CAR|3|A15C|48" & vbCrLf & "CAR|4|A15C|56" & vbCrLf & "CAR|5|A15C|64" & vbCrLf & "CAR|6|A15C|72" & vbCrLf & "CAR|7|A15C|88" & vbCrLf & "CAR|8|A15C|105" & vbCrLf & "CAR|9|A15C|125" & vbCrLf & "CAR|0|E15D|40" & vbCrLf & "CAR|1|E15D|45" & vbCrLf & "CAR|2|E15D|50" & vbCrLf & "CAR|3|E15D|55" & vbCrLf & "CAR|4|E15D|60" & vbCrLf & "CAR|5|E15D|65" & vbCrLf & "CAR|6|E15D|72" & vbCrLf & "CAR|7|E15D|90" & vbCrLf & "CAR|8|E15D|96" & vbCrLf & "CAR|0|E15C|40" & vbCrLf & "CAR|1|E15C|45" & vbCrLf & "CAR|2|E15C|50" & vbCrLf & "CAR|3|E15C|55" & vbCrLf & _
    "CAR|4|E15C|60" & vbCrLf & "CAR|5|E15C|65" & vbCrLf & "CAR|6|E15C|72" & vbCrLf & "CAR|7|E15C|90" & vbCrLf & "CAR|8|E15C|96" & vbCrLf & "CAR|0|D15D|40" & vbCrLf & "CAR|1|D15D|45" & vbCrLf & "CAR|2|D15D|50" & vbCrLf & "CAR|3|D15D|55" & vbCrLf & "CAR|4|D15D|60" & vbCrLf & "CAR|5|D15D|65" & vbCrLf & "CAR|6|D15D|72" & vbCrLf & "CAR|7|D15D|90" & vbCrLf & "CAR|8|D15D|96" & vbCrLf & "CAR|0|C15D|40" & vbCrLf & "CAR|1|C15D|45" & vbCrLf & "CAR|2|C15D|50" & vbCrLf & "CAR|3|C15D|55" & vbCrLf & "CAR|4|C15D|60" & vbCrLf & "CAR|5|C15D|65" & vbCrLf & "CAR|6|C15D|72" & vbCrLf & "CAR|7|C15D|90" & vbCrLf & "CAR|8|C15D|96"
...
''''''' ---------------------------------------------------------------
''''''Private Function RepeatedCriteria(ByVal ansName As String, ByVal vals As Long, ByVal useLiteralVAL As Boolean) As String
''''''    Dim q As String
''''''    q = Chr(34)
''''''
...
''''''        ansName & "!$R:$R," & q & q & "," & _
''''''        ansName & "!$L:$L,IF(ISBLANK($P" & vals & ")," & q & q & ",$P" & vals & ")," & _
''''''        ansName & "!$M:$M,"
''''''End Function
''''''
''''''' ---------------------------------------------------------------
''''''' Builds the chained "+COUNTIFS(...)" formula when 2+ counts for the
''''''' target pack are present in the header - a generalization of the
''''''' original "20,22" special case to any number of matched counts.
'''''''
''''''' NOTE - preserved exactly from the original: the dispatch-flag
''''''' criterion ($Q:$Q,1) is only appended to the FIRST count's block
''''''' when sPack <> "PACKHOUSE", never to subsequent chained blocks.
''''''' If that was a bug rather than intentional, flag it and I'll fix it.
''''''' ---------------------------------------------------------------
''''''Private Function BuildSummedCounts(ByVal matches As Collection, ByVal ansName As String, _
''''''                                    ByVal vals As Long, ByVal sPack As String) As String
''''''    Dim useLiteralVAL As Boolean
''''''    useLiteralVAL = (ThisWorkbook.Worksheets(ansName).Range("V1").Value <> "OFF")
''''''
''''''    Dim i As Long, result As String, v As Variant
''''''    i = 0
...
''''''                result = result & ", " & ansName & "!$Q:$Q,1"
''''''            End If
''''''        Else
''''''            result = result & CStr(v)
''''''        End If
''''''        If i < matches.Count Then
''''''            result = result & ")+COUNTIFS(" & RepeatedCriteria(ansName, vals, useLiteralVAL)
''''''        End If
''''''    Next v
''''''
''''''    BuildSummedCounts = result
''''''End Function
''''''
''''''' ---------------------------------------------------------------
''''''' MAIN ENTRY POINT
''''''' Replaces the entire nested Select Case block with a single call:
'''''''     sForm = sForm & GetSizeCriteria(shName, ansName, startline, j, vals, sPack)
'''''''
''''''' KEY RULE: the token OUTSIDE the brackets (the "leading" token) is
''''''' reserved exclusively for A15C, by business convention, in every
''''''' example seen so far. It must NEVER be offered to any other pack's
''''''' matching pool - otherwise a number like "40" that happens to be
''''''' both A15C's leading value AND some other pack's count at a
''''''' different SIZE_REF (e.g. VAL/E15D has 40 at SIZE_REF 0) gets
''''''' double-claimed. Only the BRACKET tokens are searched for non-A15C
''''''' packs, which is what "40 (22,25,50)" needs to resolve E15D -> 50
''''''' (not 40) correctly.
''''''' ---------------------------------------------------------------
''''''Public Function GetSizeCriteria(ByVal shName As String, ByVal ansName As String, ByVal startline As Long, _
''''''                                 ByVal j As Long, ByVal vals As Long, ByVal sPack As String) As String
''''''    EnsureSizeTable
''''''
''''''    Dim variety As String, pack As String, headerText As String
''''''    Dim tokens As Collection, bracketTokens As New Collection, matches As New Collection
''''''    Dim key As String, v As Variant, i As Long
''''''    Dim leadingToken As String
''''''
''''''    variety = Trim(ThisWorkbook.Worksheets(shName).Cells(vals, 4).Value)
''''''    pack = Trim(ThisWorkbook.Worksheets(shName).Cells(vals, 8).Value)
...
''''''    Next i
''''''
''''''    ' Large/Medium/Small marker (e.g. J60B cartons, whose counts are
''''''    ' text, not numbers, so they'll never appear as header tokens)
''''''    ' always overrides, regardless of pack or variety.
''''''    Select Case ThisWorkbook.Worksheets(shName).Cells(vals, j).Value
''''''        Case "Large":  GetSizeCriteria = Chr(34) & "L" & Chr(34): Exit Function
''''''        Case "Medium": GetSizeCriteria = Chr(34) & "M" & Chr(34): Exit Function
''''''        Case "Small":  GetSizeCriteria = Chr(34) & "S" & Chr(34): Exit Function
''''''    End Select
''''''
''''''    ' A15C is always the leading (outside-bracket) value - never look
''''''    ' it up in the table, and never let other packs claim it.
''''''    If pack = "A15C" Then
''''''        GetSizeCriteria = FormatToken(leadingToken)
''''''        Exit Function
''''''    End If
''''''
''''''    ' Every other pack: only the bracket tokens are eligible.
''''''    key = variety & "|" & pack
''''''    If mSizeTable.Exists(key) Then
''''''        For Each v In mSizeTable(key)
''''''            If TokenInCollection(CStr(v), bracketTokens) Then matches.Add CStr(v)
''''''        Next v
''''''    End If
''''''
''''''    If matches.Count = 0 Then
''''''        ' This pack isn't distinguished in the header at all (no
''''''        ' bracket, or none of its known counts appear there) - it
''''''        ' shares the leading/default value, same as the original
''''''        ' code's plain pass-through headers (e.g. "72" alone) and
''''''        ' the X-code branch (e.g. "1XXXX", always quoted).
''''''        GetSizeCriteria = FormatToken(leadingToken)
''''''        Exit Function
''''''    End If
''''''
''''''    If matches.Count = 1 Then
''''''        GetSizeCriteria = FormatToken(CStr(matches(1)))
''''''    Else
''''''        GetSizeCriteria = BuildSummedCounts(matches, ansName, vals, sPack)
''''''    End If
''''''End Function
...
' ---------------------------------------------------------------
' NOTE (informational only - has no effect on lookups, and is not
' shown on any generated report): of the valencia-family varieties
' that all share the "VAL" count table (VAL, DEL, APV, MKN, GSV,
' CAR), the SEEDLESS cultivars are MKN, APV, and DEL. VAL, GSV, and
' CAR are not seedless. Since they're numerically identical in
' SIZE_DATA this distinction never needs to be looked up in code -
' it's recorded here purely for future reference.
' ---------------------------------------------------------------
